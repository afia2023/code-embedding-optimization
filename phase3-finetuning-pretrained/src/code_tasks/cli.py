...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--init-method", choices=["random", "pca", "pretrained"], default="random",
                        help="Weight initialization: 'random', 'pca', or 'pretrained' (load from model-name-or-path).")
