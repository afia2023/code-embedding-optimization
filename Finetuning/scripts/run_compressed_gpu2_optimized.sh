#!/usr/bin/env bash
# ============================================================
# Experiment 2 OPTIMIZED — COMPRESSED (T5-small, d_model=320, from scratch)
# Changes vs original:
#   - batch 32 -> 64  (better GPU utilization, ~16GB/46GB)
...
OUTPUT_DIR="$PROJECT_DIR/outputs/summarization_compressed_t5small_d320_optimized"
mkdir -p "$OUTPUT_DIR"
...
echo ""
echo "=== Optimized compressed finished ==="
